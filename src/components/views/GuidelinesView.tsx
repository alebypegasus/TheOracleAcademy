...
export function GuidelinesView({ setView }: GuidelinesViewProps) {
  return (
        ...
        <PageCard className="p-10 rounded-[3rem] border border-[#1e1b4b] bg-black/40">
          ...
          <div className="prose prose-invert max-w-none space-y-10">
            <section>
              ...
              <div className="mt-6 p-6 bg-white/[0.02] border border-[#1e1b4b] rounded-3xl grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <section className="space-y-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="p-5 border border-[#1e1b4b] rounded-2xl bg-black/20">
            ...
            <section className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="flex items-center justify-between p-4 bg-white/5 border border-[#1e1b4b] rounded-2xl group hover:bg-white/10 transition-all cursor-pointer">
          ...
          <div className="mt-16 flex flex-wrap gap-4 pt-10 border-t border-[#1e1b4b]">
            ...
            <button className="flex items-center gap-3 px-6 py-3 bg-white/5 border border-[#1e1b4b] text-slate-400 rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-white/10 transition-all">

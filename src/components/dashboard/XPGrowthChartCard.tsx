      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        <div className="flex gap-4">
          <motion.div 
            ...
            className="bg-[#0A0A0B] border border-white/5 px-4 py-2 rounded-xl flex items-center gap-3 relative"
          >
            <div className="w-8 h-8 rounded-full bg-amber-500/10 flex items-center justify-center border border-amber-500/20 relative">
